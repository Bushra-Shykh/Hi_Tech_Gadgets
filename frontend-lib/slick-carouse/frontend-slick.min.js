    ...
    (e = (function () {
            ...
            e.options.arrows === !0 &&
                ...
                e.slideCount > e.options.slidesToShow
                    ? (e.$prevArrow.removeClass("slick-hidden").removeAttr("aria-hidden tabindex"),
                      ...
                      e.options.infinite !== !1 && e.$prevArrow.addClass("slick-disabled").attr("aria-disabled", "true"))
        ...
        (e.prototype.getLeft = function (i) {
            ...
            return (
                ...
                n.options.variableWidth === !0 &&
                    ((o = n.slideCount <= n.options.slidesToShow || n.options.infinite === !0 ? n.$slideTrack.children(".slick-slide").eq(i) : n.$slideTrack.children(".slick-slide").eq(i + n.options.slidesToShow)),
                    (e = n.options.rtl === !0 ? (o[0] ? (n.$slideTrack.width() - o[0].offsetLeft - o.width()) * -1 : 0) : o[0] ? o[0].offsetLeft * -1 : 0),
                    n.options.centerMode === !0 &&
                        ((o = n.slideCount <= n.options.slidesToShow || n.options.infinite === !0 ? n.$slideTrack.children(".slick-slide").eq(i) : n.$slideTrack.children(".slick-slide").eq(i + n.options.slidesToShow + 1)),
                        (e = n.options.rtl === !0 ? (o[0] ? (n.$slideTrack.width() - o[0].offsetLeft - o.width()) * -1 : 0) : o[0] ? o[0].offsetLeft * -1 : 0),
        ...
        (e.prototype.getNavigableIndexes = function () {
            var i,
                ...
                o = 0,
                s = [];
            for (e.options.infinite === !0 ? (i = e.slideCount) : ((t = e.options.slidesToScroll * -1), (o = e.options.slidesToScroll * -1), (i = 2 * e.slideCount)); t < i; )
        ...
        (e.prototype.slideHandler = function (i, e, t) {
            ...
            if (((e = e || !1), !((a.animating === !0 && a.options.waitForAnimate === !0) || (a.options.fade === !0 && a.currentSlide === i))))
                return (
                    ...
                    a.options.infinite === !0 && a.options.centerMode === !1 && (i < 0 || i > a.getDotCount() * a.options.slidesToScroll)
                        ? void (
                              a.options.fade === !1 &&
                              ((o = a.currentSlide),
                        ...
                        : a.options.infinite === !0 && a.options.centerMode === !0 && (i < 0 || i > a.slideCount - a.options.slidesToScroll)
                        ? void (
                              a.options.fade === !1 &&
                              ((o = a.currentSlide),
                              t !== !0 && a.slideCount > a.options.slidesToShow
