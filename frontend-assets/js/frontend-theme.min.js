!(function (e) {
    ...
    var s = {
                    ...
                    (o.hasClass("slick-initialized") ||
                        o.slick({
                            ...
                            responsive: [
                                ...
                                { breakpoint: 552, settings: { dots: s, arrows: r, slidesToShow: 2, slidesToScroll: 1 } },
                            ],
                        }));
            });
        },
                    ...
                    (o.hasClass("slick-initialized") ||
                        (t.hasClass("custom-product-carousel")
                            ...
                            : o.slick({
                                  ...
                                  prevArrow: '<button type="button" class="slick-arrow slick-prev" aria-label="Slide Prev">' + l + "</button>",
                                  responsive: [
                                      { breakpoint: 552, settings: { dots: s, arrows: r, slidesToShow: 3, slidesToScroll: 1 } },
        ...
        initOpenSearchForm: function () {
            ...
            (btnClose = e(".background-header-search, .halo-search-close")),
                a.focus(function () {
        ...
        initEditQuickCart: function () {
            ...
            (btnclose = e(".background-overlay-popup, .halo-popup-close")),
                o.length &&
                    (o.on("click", (e) => {
        ...
        initNewsLetterPopup: function () {
            ...
            if (a.length > 0) {
                ...
                setTimeout(function () {
                    t.addClass("newsletter-hide");
                }, i),
                    s.click(function (e) {
                        t.removeClass("newsletter-hide");
                    }),
        ...
        initZoomImage: function () {
            ...
            a.width() > 1024 &&
                t.each((t, o) => {
                    var i = e(o);
                    a.width() > 1024 ? i.zoom({ url: i.attr("data-zoom-image"), touch: !1 }) : i.trigger("zoom.destroy");
                });
        },
                  ...
                  (o.hasClass("productView-nav-gallery")
                      ...
                      : (t.slick({
                            ...
                            responsive: [
                                ...
                                { breakpoint: 1025, settings: { vertical: !1 } },
                            ],
                        }),
                        o.slick({
                            fade: !0,
